 ...
 ** @{ */
/** \addtogroup MPU6050 MPU6050
 ** @{ */

/** \brief MPU6050 sensor module is a 6-axis Motion Tracking Device. It combines 3-axis Accelerometer and 3-axis Gyroscope. It communicates with the EDU-ESP
 * board via I2C.
 * 
